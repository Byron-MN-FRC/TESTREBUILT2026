...
public class shooterSpin extends Command {
    ...
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=VARIABLE_DECLARATIONS
        private final Turrent m_motors;
    ...
    public shooterSpin(Turrent subsystem) {
    ...
    @Override
    public void execute() {
        SmartDashboard.putNumber("Rotation", m_motors.rotateShooterMotor.getPosition().getValueAsDouble());
        ...
        if (RobotContainer.getInstance().userController.getLeftBumperButtonPressed()) {
            m_motors.spinLeft();
            if (m_motors.zeroSwitch.get() == true) {
                m_motors.rotateShooterMotor.set(0);
            }
        }
