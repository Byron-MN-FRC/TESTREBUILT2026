...
public class Shooter extends SubsystemBase {
  ...
  public Shooter() {
    ...
    leftShoot = new TalonFX(24, "Canivore1");
    ...
    // I don't think that leftShoot is intended to be following itself here
    // leftShoot.setControl(new Follower(leftShoot.getDeviceID(),
